...
<?php
$sql = "SELECT * FROM noticias ORDER BY Datapubli DESC LIMIT 4";
...
?>
  ...
  <div class="row" style="margin-top:25px;">
    <div class="col s12 m8">
      <div class="card">
        <div class="card-image">
          <img src="<?= htmlspecialchars($noticias[0]['Imagem']) ?>" style="height:350px; object-fit:cover;">
        </div>
        <div class="card-content">
          <span class="card-title">
            <?= htmlspecialchars($noticias[0]['Titulo']) ?>
          </span>
          <p>
    ...
    <!-- COLUNA LATERAL (opcional futura) -->
        ...
        <div class="card small">
          ...
          <div class="card-content">
            <span class="card-title" style="font-size:16px;">
              <?= htmlspecialchars($noticias[$i]['Titulo']) ?>
            </span>
          </div>
        </div>
      </div>
