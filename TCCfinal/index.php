...
?>
  <!-- Mural de notícias -->
<section id="inicio" class="green lighten-2 center-align" style="padding: 50px 0;">
  <?php
  // Consulta as notícias em ordem decrescente de data
  ...
  if (mysqli_num_rows($resultado) > 0) {
      ...
      while ($linha = mysqli_fetch_assoc($resultado)) {
          ...
          $dataBrasileira = date('d/m/Y H:i', strtotime($linha['Datapubli']));

          echo '<div class="card" style="margin: 20px auto; max-width: 700px;">';

          // Exibe imagem
          echo '  <div class="card-image">';
          echo '      <img src="' . htmlspecialchars($linha['Imagem']) . '" alt="Imagem da notícia" style="max-width:100%; height:auto;">';
          echo '  </div>';

          // Exibe conteúdo textual
          echo '  <div class="card-content">';
          echo '      <h5>' . htmlspecialchars($linha['Titulo']) . '</h5>';
          echo '      <p><em>Publicado em: ' . $dataBrasileira . '</em></p>';
          ...
          if (!empty($linha['tags'])) {
              ...
              echo '<small><strong>Tags:</strong> ' . htmlspecialchars($linha['tags']) . '</small>';
              echo '</div>';
          }
      ...
      <div class="row">
            <div class="col s12 m3">
              ...
              <div class="card-image">
                <img src="imagens/CPTonDible.png" width="300" height="300">
                  </div>
                </div>
            </div>
             <div class="col s12 m3">
                <div class="card">
              <div class="card-image">
                <img src="imagens/celaodopneu.png" width="300" height="300">
                  </div>
                </div>
            </div>
             <div class="col s12 m3">
                <div class="card">
              <div class="card-image">
                <img src="imagens/curryyyy.png" width="300" height="300">
                  </div>
                </div>
            </div>
             <div class="col s12 m3">
                <div class="card">
              <div class="card-image">
                <img src="imagens/gringocomcontato.png" width="300" height="300">
                  </div>
                </div>
            </div>
  ...
  <!-- Footer -->
   <footer class="page-footer green">
    ...
    <div class="footer-copyright">
      <div class="container">
      Teste do <a class="white-text text-lighten-3" href="http://materializecss.com">Escobar</a>
      </div>
    </div>
  </footer>
